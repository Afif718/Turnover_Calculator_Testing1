...
//All TAB 2 calculations will be done from this function
  if(B3.value != "" && B4.value != "" && B5.value != "" &&
   ...
   B19.value != "" && B20.value != ""
    ...
    var F19 = B19.value /50/40; 
    console.log("F19 Result from TAB 2: " + F19);
    var F20 = B20.value /50/40;
...
//   + " " + B25.value + " " + C25.value + " " + B26.value + " " + C26.value);
   ...
   //final Result 
   var E49 = F27 + F31 + Number(F38) + F45; //Total Turnover Cost (RM) for one employee
   ...
   var E51 = E49 * Number(B6.value); //Estimated Annual Turnover Cost (RM) 
